...
Run `/home/deploy/bin/perf-traits-audit.sh global-hope-india` for full detail. Remediation guidance in [performance-gate.md](/home/deploy/claude-config/rules/performance-gate.md).
<!-- perf-traits:end -->
